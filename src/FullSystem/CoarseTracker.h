...
private:
    ...
    void calcGSSSEDoubleIMU(int lvl, Mat3232 &H_out, Vec32 &b_out, const gtsam::NavState navState_previous_, const gtsam::NavState navState_current_, AffLight aff_g2l);
