...
Vec4 FullSystem::trackNewCoarse(FrameHessian* fh)
{
	...
	else
	{
		...
		SE3 prop_pose(prop_lastF_2_fh_r.rotationMatrix(), const_vel_lastF_2_fh.matrix().block<3, 1>(0, 3));
