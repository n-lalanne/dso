//
// Created by sicong on 11/07/17.
//

#ifndef DSO_PREINTEGRATOR_H
#define DSO_PREINTEGRATOR_H
...
namespace dso_vi
{
 ...
 //   Mat33 Myhat(const Vector3d & v);
 //   dso::SO3 expAndTheta(const Vector3d & omega, double * theta);
//    dso::SO3 exp(const Vector3d & omega);
